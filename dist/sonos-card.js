 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vt=t=>!(t=>null===t||"object"!=typeof t&&"function"!=typeof t)(t)&&"function"==typeof t.then;const mt=it(class extends dt{constructor(){super(...arguments),this._$Cft=1073741823,this._$Cwt=[],this._$CG=new pt(this),this._$CK=new ut}render(...t){var e;return null!==(e=t.find((t=>!vt(t))))&&void 0!==e?e:T}update(t,e){const i=this._$Cwt;let s=i.length;this._$Cwt=e;const o=this._$CG,r=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cft);t++){const n=e[t];if(!vt(n))return this._$Cft=t,n;t<s&&n===i[t]||(this._$Cft=1073741823,s=0,Promise.resolve(n).then((async t=>{for(;r.get();)await r.get();const e=o.deref();if(void 0!==e){const i=e._$Cwt.indexOf(n);i>-1&&i<e._$Cft&&(e._$Cft=i,e.setValue(t))}})))}return T}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}}),ft=((t,...e)=>{const s=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new o(s,i)})`
  ha-card {
...
`,gt=["entities","favorites","active"],_t="mdi:skip-next",bt={playing:"mdi:pause",paused:"mdi:play"},yt="mdi:skip-previous";console.info("%c SONOS-CARD \n%c Version: 2.0.0-beta4    ","color: red; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"sonos-card",name:"Sonos-Card",preview:!1,description:"A responsive Sonos card with support for groups and playlists"});let $t=class extends Z{constructor(){super(),this.entities={},this.active=""}setConfig(t){if(!t.entities)throw new Error("You need to define entities");this.config=Object.assign({name:"Sonos"},t)}set hass(t){if(!t)return;this._hass=t;let e=!1;for(const t of this.config.entities){const i=this._hass.states[t],s=this.entities[t];s?i&&JSON.stringify(s)!==JSON.stringify(i)&&(this.entities[t]=i,e=!0):(this.entities[t]=i,e=!0)}e&&this.requestUpdate("entities")}shouldUpdate(t){if(!this.config)return!1;return gt.some((e=>t.has(e)))}render(){const t=[],e=[];let i=!0;for(const s of this.config.entities){const o=this._hass.states[s];if(i){i=!1;for(const t of this.config.favorites)e.push(t)}t[s]=o.attributes.friendly_name,o.attributes.group_members.length>1&&o.attributes.group_members[0]==s?"playing"==o.state&&""==this.active&&(this.active=s):1==o.attributes.group_members.length&&"playing"==o.state&&""==this.active&&(this.active=s)}return""===this.active&&this.config.entities.length>0&&(this.active=this.config.entities[0]),P`
      <ha-card
        .header="sonos-card">
        <div class="container">
          <div class="players">
            ${this.config.entities.map((e=>{const i=this._hass.states[e];return 1==i.attributes.group_members.length||i.attributes.group_members.length>1&&i.attributes.group_members[0]==e?P`
                  <div class="group ${this.active==e?"active":""}" data-entity="${e}" @click="${t=>this.switchGroup(t)}">
                    ...
                    <span class="cover-icon">${mt(this.renderIcon(i))}</span>
                    ${i.attributes.group_members.map((e=>P`<span class="name">${t[e]}</span>`))}
          ...
          <div class="player-main">
            ${""!=this.active?P`
                  <div class="player">
                    <div class="body__cover">${mt(this.renderCover(this._hass.states[this.active]))}</div>
            ...
            <div class="extra-players">
              <div class="members">
                ${""!=this.active?P`${this._hass.states[this.active].attributes.group_members.map((e=>e!=this.active?P`
                        ...
                        `:P``))}
                    ${this.config.entities.map((e=>e==this.active||this._hass.states[this.active].attributes.group_members.includes(e)?P``:P`
